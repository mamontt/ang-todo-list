...
import {fromBankOfficialStatusFilters} from '../../../../pages/letter-scroller/official/scroller-parts/filter/from-bank/filter-options';
...
import {officialActionFabriqueFromBank} from './official-action-fabrique-from-bank';
import {
    TableViewFromBank,
    QuickViewFromBank,
    FilterViewFromBank,
...
export const initialParams = {
    ...
    ...{filters: {statusCategory: head(fromBankOfficialStatusFilters).query}}
};

export class OfficialLetterScrollerFromBank extends PureComponent<LetterScrollerProps> {
    render() {
        return (
